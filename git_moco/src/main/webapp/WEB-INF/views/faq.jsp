    ...
    <body>
        ...
        <div class="js__parallax-window" style="background: url(resources/assets/img/moco/bg_camera.png) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-padding-y-150--xs">
                <div class="g-margin-b-60--xs">
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-80--md g-color--white g-letter-spacing--1 g-margin-b-30--xs">FAQ</h1>
        ...
        <div class="s-faq g-bg-color--primary" style="background-color:white;">
            <div class="container g-padding-y-125--xs" >
            	<p class="info" style="text-align: left; padding-left:23rem;"> * 답변 내용을 보시려면 질문을 클릭해 주세요.</p>
        ...
        <!-- 답변 나타나게 하기 -->
       	<script type="text/javascript">
       		function answer_01(){
       			$('#answer01').html('<p class="p_answer"> >> MOCO앱에서 제어를 원하는 기기의 시리얼 넘버를 입력하고 등록 버튼을 누르면 등록이 완료됩니다. </p>');
       		}
